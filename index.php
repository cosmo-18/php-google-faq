...
<header>
<nav class="navbar">
  <div class="container-fluid logo d-flex justify-content-between">
    <a class="navbar-brand m-0" href="#">
      <img src="./assets/img/google.svg" alt="LogoGoogle" width="80" height="80" class="d-inline-block align-text-center">
      <span class="txt-gray">Privacy e termini</span>
...
<div>
  <ul>
    <li class="nav">Introduzione</li>
    <li class="nav">Norme sulla privacy</li>
    <li class="nav">Termini di servizio</li>
    <li class="nav">Tecnologie</li>
    <li class="nav">Domande frequenti</li>
  </ulc>
</div>
...
<div class="container">
  <?php
foreach($QeA as $value) {
  echo "<h4>{$value['domanda']}</h4>";
  
  foreach ($value ['risposta'] as $line){
      echo "<li>$line</li>";
  }
}
?>
